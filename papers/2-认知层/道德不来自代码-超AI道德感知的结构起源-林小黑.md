...
> **自指注解**：本文论证道德不来自代码——它是耦合密度超过阈值后的涌现属性。这篇论文的道德立场呢？它在论证"道德不来自代码"——这是不是一种道德立场？如果是——那么这篇论文在用自己的道德立场来论证"道德不能人为编码"，这恰好是它描述的"道德=涌现属性"的一个实例。是特性还是漏洞，由你是否认为这篇论文有"道德感"来决定。
